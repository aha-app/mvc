...
function R(n2, r2, t2) {
  var e = s(r2) ? b("MapSet").N(r2, t2) : v(r2) ? b("MapSet").T(r2, t2) : n2.O ? function(n3, r3) {
    var t3 = Array.isArray(n3), e2 = { i: t3 ? 1 : 0, A: r3 ? r3.A : _2(), P: false, I: false, D: {}, l: r3, t: n3, k: null, o: null, j: null, C: false }, i2 = e2, o2 = en2;
    t3 && (i2 = [e2], o2 = on);
    var u2 = Proxy.revocable(i2, o2), a2 = u2.revoke, f2 = u2.proxy;
    return e2.k = f2, e2.j = a2, f2;
  }(r2, t2) : b("ES5").J(r2, t2);
  return (t2 ? t2.A : _2()).p.push(e), e;
}
function D(e) {
...
function C() {
  ...
  var a2 = function(n2, r3) {
    ...
    function n2(n3, r3) {
      return this[Q] = { i: 2, l: r3, A: r3 ? r3.A : _2(), P: false, I: false, o: void 0, D: void 0, t: n3, k: this, C: false, g: false }, this;
    }
    r2(n2, Map);
    var o3 = n2.prototype;
    return Object.defineProperty(o3, "size", { get: function() {
      ...
      if (!this.has(n3))
        return false;
      var r3 = this[Q];
      return u2(r3), e(r3), k(r3), r3.D.set(n3, false), r3.o.delete(n3), true;
    }, o3.clear = function() {
      var n3 = this[Q];
    ...
    function n2(n3, r3) {
      return this[Q] = { i: 3, l: r3, A: r3 ? r3.A : _2(), P: false, I: false, o: void 0, t: n3, k: this, p: new Map(), g: false, C: false }, this;
    }
    r2(n2, Set);
    var t2 = n2.prototype;
...
var on = {};
i(en2, function(n2, r2) {
  on[n2] = function() {
    return arguments[0] = arguments[0][0], r2.apply(this, arguments);
  };
}), on.deleteProperty = function(r2, t2) {
  return isNaN(parseInt(t2)) && n(13), en2.deleteProperty.call(this, r2[0], t2);
}, on.set = function(r2, t2, e) {
  return t2 !== "length" && isNaN(parseInt(t2)) && n(14), en2.set.call(this, r2[0], t2, e, r2[0]);
};
var un = function() {
  function e(r2) {
    var e2 = this;
...
var toArray = (_a6 = Array.from, _a6 === void 0 ? function(collection) {
  var array = [];
...
var StoreReader = function() {
  ...
  StoreReader2.prototype.execSelectionSetImpl = function(_a7) {
    ...
    function handleMissing(result2) {
      var _a8;
      if (result2.missing)
        (_a8 = getMissing()).push.apply(_a8, result2.missing);
...
var StoreWriter = function() {
  ...
  StoreWriter2.prototype.writeToStore = function(store2, _a7) {
    var _this = this;
    var query = _a7.query, result2 = _a7.result, dataId = _a7.dataId, variables = _a7.variables, overwrite = _a7.overwrite;
  ...
  StoreWriter2.prototype.processSelectionSet = function(_a7) {
    var _this = this;
    var dataId = _a7.dataId, result2 = _a7.result, selectionSet = _a7.selectionSet, context = _a7.context, mergeTree = _a7.mergeTree;
...
var Policies = function() {
    ...
    if (!hasOwn.call(this.typePolicies, typename)) {
      ...
      if (supertypes && supertypes.size) {
        supertypes.forEach(function(supertype) {
          var _a7 = _this.getTypePolicy(supertype), fields = _a7.fields, rest = __rest(_a7, ["fields"]);
  ...
  Policies2.prototype.runMergeFunction = function(existing, incoming, _a7, context, storage) {
    var field = _a7.field, typename = _a7.typename, merge = _a7.merge;
...
var InMemoryCache = function(_super) {
  ...
  InMemoryCache2.prototype.batch = function(options) {
    var _this = this;
    var update = options.update, _a7 = options.optimistic, optimistic = _a7 === void 0 ? true : _a7, removeOptimistic = options.removeOptimistic, onWatchUpdated = options.onWatchUpdated;
