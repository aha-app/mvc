  ...
  'node_modules/debug/src/common.js'(exports2, module2) {
    function setup(env) {
      ...
      function enable(namespaces) {
        ...
        createDebug.skips = [];
        let i2;
        const split2 = (typeof namespaces === 'string' ? namespaces : '').split(
          /[\s,]+/
        );
    ...
    (function UMD(name, context, definition) {
      ...
      function CAF2(generatorFn) {
        return function instance(tokenOrSignal, ...args) {
          var signal, signalPr;
          ({ tokenOrSignal, signal, signalPr } =
            processTokenOrSignal(tokenOrSignal));
          if (signal.aborted) {
            return signalPr;
          }
          ...
          var { it, result: result3 } = _runner.call(
            this,
            generatorFn,
            signal,
            ...args
      ...
      function getSignalPr(signal) {
        return (
          signal.pr ||
          new Promise(function c2(res, rej) {
      ...
      function processTokenOrSignal(tokenOrSignal) {
        ...
        var signal =
          tokenOrSignal && tokenOrSignal instanceof cancelToken
              ...
              if (nextResult2.done) {
                ...
                prNext = prNext.then(
                  ...
                  function onRejection(reason) {
                    return Promise.resolve(it.throw(reason)).then(
                      processResult
                    );
                  }
                );
  ...
  'node_modules/tslib/tslib.js'(exports2, module2) {
    ...
    (function (factory) {
      ...
      var extendStatics =
        ...
        function (d2, b2) {
          for (var p2 in b2)
            if (Object.prototype.hasOwnProperty.call(b2, p2)) d2[p2] = b2[p2];
        };
      __extends2 = function (d2, b2) {
        ...
        d2.prototype =
          b2 === null
            ? Object.create(b2)
            : ((__2.prototype = b2.prototype), new __2());
      };
      __assign2 =
        Object.assign ||
        function (t2) {
      ...
      __awaiter2 = function (thisArg, _arguments, P2, generator) {
        ...
        return new (P2 || (P2 = Promise))(function (resolve, reject2) {
          ...
          function step(result3) {
            result3.done
              ? resolve(result3.value)
              : adopt(result3.value).then(fulfilled, rejected);
          }
      ...
      __spreadArrays2 = function () {
        ...
        for (var r2 = Array(s2), k2 = 0, i2 = 0; i2 < il; i2++)
          for (
            var a2 = arguments[i2], j2 = 0, jl = a2.length;
            j2 < jl;
            j2++, k2++
          )
            r2[k2] = a2[j2];
      ...
      __asyncGenerator2 = function (thisArg, _arguments, generator) {
        ...
        function step(r2) {
          r2.value instanceof __await2
            ? Promise.resolve(r2.value.v).then(fulfill, reject2)
            : settle(q2[0][2], r2);
        }
...
var proxyHandlers = Object.freeze(
  Object.getOwnPropertyNames(Reflect).reduce(
    (handlers2, key) =>
      _objectSpread2(
        _objectSpread2({}, handlers2),
        {},
        {
          [key]: Reflect[key],
        }
...
function runHandler(handlers2, name, target, ...args) {
  ...
  var handler =
    (options === null || options === void 0
      ? void 0
      : (_options$handlers = options[handlers2]) === null ||
        _options$handlers === void 0
      ? void 0
      : _options$handlers[name]) || defaultHandlers[handlers2][name];
...
var collectionHandlers$1 = {
  ...
  forEach(callback, ...args) {
    ...
    var wrappedCallback = (value, ...rest2) =>
      callback(observableChild(value, target), ...rest2);
...
var collectionHandlers$2 = {
  get(target, key, receiver) {
    target = collectionHandlers$1.hasOwnProperty(key)
      ? collectionHandlers$1
      : target;
...
var handlers = new Map([
  [Map, collectionHandlers$2],
  [Set, collectionHandlers$2],
  [WeakMap, collectionHandlers$2],
  [WeakSet, collectionHandlers$2],
  [Object, false],
  [Array, false],
  [Int8Array, false],
  [Uint8Array, false],
...
function createObservable(obj, options) {
  ...
  var observable2 = new Proxy(
    obj,
    _objectSpread2(
      _objectSpread2(
        {},
        options === null || options === void 0 ? void 0 : options.proxyHandlers
      ),
      baseHandlers
    )
  );
...
function batchSetState(viewIndex, fn2) {
  ...
  if (!taskPending) {
    ...
    queueMicrotask(() => {
      ...
      taskPending = false;
      batchesPending = {};
      (0, react_platform_exports.unstable_batchedUpdates)(() =>
...
function batch(fn2, ctx, args) {
  if (scheduler.isOn) {
    return (0, react_platform_exports.unstable_batchedUpdates)(() =>
      fn2.apply(ctx, args)
    );
  }
  try {
...
function batchMethod(obj, method2) {
  ...
  const { value, writable, set: set3, configurable } = descriptor;
  if (configurable && typeof set3 === 'function') {
    Object.defineProperty(
      obj,
      method2,
      _objectSpread22({}, descriptor, {
        set: batchFn(set3),
      })
    );
...
function toInteger(value) {
  var result3 = toFinite_default(value),
    remainder = result3 % 1;
...
function composeArgs(args, partials, holders, isCurried) {
  var argsIndex = -1,
    ...
    result3 = Array(leftLength + rangeLength),
...
function composeArgsRight(args, partials, holders, isCurried) {
  var argsIndex = -1,
    ...
    result3 = Array(rangeLength + rightLength),
    isUncurried = !isCurried;
...
function getFuncName(func) {
  var result3 = func.name + '',
    array = realNames_default[result3],
    length = hasOwnProperty4.call(realNames_default, result3)
      ? array.length
      : 0;
  while (length--) {
...
function wrapperClone(wrapper) {
  ...
  var result3 = new LodashWrapper_default(
    wrapper.__wrapped__,
    wrapper.__chain__
  );
...
function arrayLikeKeys(value, inherited) {
  var isArr = isArray_default(value),
    ...
    result3 = skipIndexes ? baseTimes_default(value.length, String) : [],
...
function baseKeysIn(object) {
  ...
  for (var key in object) {
    if (
      !(
        key == 'constructor' &&
        (isProto || !hasOwnProperty11.call(object, key))
      )
    ) {
      result3.push(key);
    }
...
function hashHas(key) {
  ...
  return nativeCreate_default
    ? data[key] !== void 0
    : hasOwnProperty13.call(data, key);
}
...
function chunk(array, size2, guard) {
  ...
  var index = 0,
    resIndex = 0,
    result3 = Array(nativeCeil(length / size2));
  while (index < length) {
...
function baseGetAllKeys(object, keysFunc, symbolsFunc) {
  ...
  return isArray_default(object)
    ? result3
    : arrayPush_default(result3, symbolsFunc(object));
}
...
if (
  ...
  getTag = function (value) {
    var result3 = baseGetTag_default(value),
      Ctor = result3 == objectTag3 ? value.constructor : void 0,
...
function initCloneArray(array) {
  ...
  if (
    ...
    hasOwnProperty15.call(array, 'index')
  ) {
...
function baseClone(value, bitmask, customizer, key, object, stack) {
  ...
  if (isArr) {
    ...
    var tag = getTag_default(value),
      isFunc2 = tag == funcTag3 || tag == genTag2;
    ...
    if (tag == objectTag4 || tag == argsTag3 || (isFunc2 && !object)) {
      ...
      if (!isDeep) {
        return isFlat
          ? copySymbolsIn_default(value, baseAssignIn_default(result3, value))
          : copySymbols_default(value, baseAssign_default(result3, value));
      }
    } else {
...
function equalByTag(object, other, tag, bitmask, customizer, equalFunc, stack) {
  switch (tag) {
    ...
    case setTag6:
      ...
      var result3 = equalArrays_default(
        convert(object),
        convert(other),
        bitmask,
        customizer,
...
function baseIsEqualDeep(object, other, bitmask, customizer, equalFunc, stack) {
  ...
  if (!(bitmask & COMPARE_PARTIAL_FLAG4)) {
    var objIsWrapped = objIsObj && hasOwnProperty17.call(object, '__wrapped__'),
      othIsWrapped = othIsObj && hasOwnProperty17.call(other, '__wrapped__');
...
function getMatchData(object) {
  var result3 = keys_default(object),
    length = result3.length;
  while (length--) {
...
function curry(func, arity, guard) {
  ...
  var result3 = createWrap_default(
    func,
    WRAP_CURRY_FLAG6,
    void 0,
    void 0,
    ...
    while (++propsIndex < propsLength) {
      ...
      if (
        ...
        (eq_default(value, objectProto21[key]) &&
          !hasOwnProperty19.call(object, key))
      ) {
...
function baseMap(collection, iteratee2) {
  var index = -1,
    result3 = isArrayLike_default(collection) ? Array(collection.length) : [];
  baseEach_default(collection, function (value, key, collection2) {
  ...
  outer: while (++index < length && result3.length < maxLength) {
    ...
    if (
      ...
      while (--othIndex) {
        ...
        if (
          !(cache2
            ? cacheHas_default(cache2, computed)
...
var invokeMap = baseRest_default(function (collection, path, args) {
  var index = -1,
    isFunc2 = typeof path == 'function',
    result3 = isArrayLike_default(collection) ? Array(collection.length) : [];
  baseEach_default(collection, function (value) {
    result3[++index] = isFunc2
...
function mixin(object, source, options) {
  ...
  var chain2 =
    ...
    isFunc2 = isFunction_default(object);
      ...
      object.prototype[methodName] = function () {
        ...
        if (chain2 || chainAll) {
          var result3 = object(this.__wrapped__),
            actions = (result3.__actions__ = copyArray_default(
              this.__actions__
            ));
...
function nth(array, n2) {
  return array && array.length
    ? baseNth_default(array, toInteger_default(n2))
    : void 0;
}
var nth_default = nth;
...
function compareMultiple(object, other, orders) {
  ...
  while (++index < length) {
    var result3 = compareAscending_default(
      objCriteria[index],
      othCriteria[index]
    );
    if (result3) {
...
function createPadding(length, chars) {
  ...
  var result3 = baseRepeat_default(
    chars,
    nativeCeil2(length / stringSize_default(chars))
  );
  return hasUnicode_default(chars)
    ? castSlice_default(stringToArray_default(result3), 0, length).join('')
...
var pullAt = flatRest_default(function (array, indexes) {
  var length = array == null ? 0 : array.length,
    result3 = baseAt_default(array, indexes);
  basePullAt_default(
    array,
...
function arraySampleSize(array, n2) {
  return shuffleSelf_default(
    ...
    baseClamp_default(n2, 0, array.length)
  );
}
...
function times(n2, iteratee2) {
  ...
  var index = MAX_ARRAY_LENGTH6,
    length = nativeMin12(n2, MAX_ARRAY_LENGTH6);
  ...
  return arrayReduce_default(
    ...
    function (result4, action) {
      return action.func.apply(
        action.thisArg,
        arrayPush_default([result4], action.args)
      );
    },
    result3
  );
...
function baseXor(arrays, iteratee2, comparator) {
  ...
  while (++index < length) {
    ...
    while (++othIndex < length) {
      if (othIndex != index) {
        result3[index] = baseDifference_default(
          result3[index] || array,
          arrays[othIndex],
          iteratee2,
          comparator
...
function lazyValue() {
  var array = this.__wrapped__.value(),
    ...
    view2 = getView_default(0, arrLength, this.__views__),
    start = view2.start,
    end = view2.end,
    length = end - start,
...
var ApplicationController = class {
  ...
  internalInitialize(parentController, initialArgs) {
    if (!this.initialized) {
      ...
      this.state = store(
        lodash_default_default.cloneDeep(this.constructor.initialState)
      );
  ...
  createClass(Inflector2, [
    ...
    },
    {
      ...
      value: function uncountable() {
        for (
          var _len = arguments.length, words2 = Array(_len), _key = 0;
          _key < _len;
          _key++
        ) {
...
function pluralize(word) {
  var locale =
    arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 'en';
...
function camelize(term, uppercaseFirstLetter) {
  ...
  result3 = result3.replace(
    /(?:_|(\/))([a-z\d]*)/gi,
    function (match, a2, b2, idx, string) {
      a2 || (a2 = '');
    ...
    },
    {
      ...
      value: function transliterate(string, replacement) {
        ...
        return string.replace(/[^\u0000-\u007f]/g, function (c2) {
          return (
            _this.approximations[c2] || replacement || DEFAULT_REPLACEMENT_CHAR
          );
        });
      },
    },
...
var Errors = class {
  ...
  on(attribute) {
    var _a7;
    return (
      ((_a7 = this.errors[attribute]) == null ? void 0 : _a7.messages) || []
    );
  }
  has(attribute) {
...
function n(n2) {
  for (
    var t2 = arguments.length, r2 = Array(t2 > 1 ? t2 - 1 : 0), e = 1;
    e < t2;
    e++
  )
    r2[e - 1] = arguments[e];
...
function r(n2) {
  return (
    ...
    ((function (n3) {
      ...
      return (
        r2 === Object ||
        (typeof r2 == 'function' && Function.toString.call(r2) === Z)
      );
    })(n2) ||
      Array.isArray(n2) ||
      !!n2[L] ||
...
function i(n2, t2, r2) {
  r2 === void 0 && (r2 = false),
    o(n2) === 0
      ? (r2 ? Object.keys : nn)(n2).forEach(function (e) {
...
function u(n2, t2) {
  return o(n2) === 2
    ? n2.has(t2)
    : Object.prototype.hasOwnProperty.call(n2, t2);
}
function a(n2, t2) {
...
function l(n2) {
  ...
  for (var r2 = nn(t2), e = 0; e < r2.length; e++) {
    var i2 = r2[e],
      o2 = t2[i2];
    o2.writable === false && ((o2.writable = true), (o2.configurable = true)),
      (o2.get || o2.set) &&
        (t2[i2] = {
          configurable: true,
          writable: true,
...
function P(t2, e) {
  ...
  var i2 = e.p[0],
    o2 = t2 !== void 0 && t2 !== i2;
  return (
    e.h.g || b('ES5').S(e, t2, o2),
    o2
      ? (i2[Q].P && (O(e), n(4)),
        r(t2) && ((t2 = M(e, t2)), e.l || x(e, t2)),
        e.u && b('Patches').M(i2[Q], t2, e.u, e.s))
      : (t2 = M(e, i2, [])),
    O(e),
    e.u && e.v(e.u, e.s),
    t2 !== H ? t2 : void 0
...
function M(n2, t2, r2) {
  ...
  if (!e.I) {
    ...
    i(e.i === 3 ? new Set(o2) : o2, function (t3, i2) {
      ...
      x(n2, o2, false),
      r2 && n2.u && b('Patches').R(e, r2, n2.u, n2.s);
  }
  return e.o;
}
function A(e, i2, o2, a2, c2, s2) {
  if ((c2 === o2 && n(5), t(c2))) {
    var v2 = M(
      e,
      c2,
      s2 && i2 && i2.i !== 3 && !u(i2.D, a2) ? s2.concat(a2) : void 0
    );
    ...
    f2 = (function () {
      ...
      return (
        ...
        (o3.delete = function (n3) {
          ...
          var t3 = this[Q];
          return (
            u2(t3), e(t3), k(t3), t3.D.set(n3, false), t3.o.delete(n3), true
          );
        }),
        (o3.clear = function () {
          var n3 = this[Q];
        ...
        (o3.get = function (n3) {
          ...
          u2(t3);
          var i2 = p(t3).get(n3);
          if (t3.I || !r(i2)) return i2;
          if (i2 !== t3.t.get(n3)) return i2;
      ...
      return (
        ...
        (r2.has = function (n3) {
          ...
          return (
            u2(t3),
            t3.o
              ? !!t3.o.has(n3) || !(!t3.p.has(n3) || !t3.o.has(t3.p.get(n3)))
              : t3.t.has(n3)
          );
        }),
        (r2.add = function (n3) {
        ...
        (r2.delete = function (n3) {
          ...
          return (
            ...
            o2(t3),
            k(t3),
            t3.o.delete(n3) || (!!t3.p.has(n3) && t3.o.delete(t3.p.get(n3)))
          );
        }),
        (r2.clear = function () {
          var n3 = this[Q];
...
var en2 = {
  ...
  set: function (n2, t2, r2) {
    var e = I(p(n2), t2);
    if (e == null ? void 0 : e.set) return e.set.call(n2.k, r2), true;
    if (!n2.P) {
      var i2 = z(p(n2), t2),
        o2 = i2 == null ? void 0 : i2[Q];
      if (o2 && o2.t === r2) return (n2.o[t2] = r2), (n2.D[t2] = false), true;
      if (c(r2, i2) && (r2 !== void 0 || u(n2.t, t2))) return true;
      E(n2), k(n2);
    }
    return (
      (n2.o[t2] === r2 &&
        typeof r2 != 'number' &&
        (r2 !== void 0 || t2 in n2.o)) ||
      ((n2.o[t2] = r2), (n2.D[t2] = true), true)
    );
  },
  deleteProperty: function (n2, t2) {
    return (
      z(n2.t, t2) !== void 0 || t2 in n2.t
        ? ((n2.D[t2] = false), E(n2), k(n2))
        : delete n2.D[t2],
      n2.o && delete n2.o[t2],
      true
    );
  ...
  getOwnPropertyDescriptor: function (n2, t2) {
    var r2 = p(n2),
      e = Reflect.getOwnPropertyDescriptor(r2, t2);
    return e
      ? {
          writable: true,
          configurable: n2.i !== 1 || t2 !== 'length',
...
i(en2, function (n2, t2) {
  ...
  (on.deleteProperty = function (t2, r2) {
    return (
      isNaN(parseInt(r2)) && n(13), en2.deleteProperty.call(this, t2[0], r2)
    );
  }),
  (on.set = function (t2, r2, e) {
    return (
      r2 !== 'length' && isNaN(parseInt(r2)) && n(14),
      en2.set.call(this, t2[0], r2, e, t2[0])
    );
  });
var un = (function () {
  function e(t2) {
    ...
    (this.g = B),
      (this.F = true),
      (this.produce = function (t3, i3, o2) {
        ...
        var f2;
        if (
          (typeof i3 != 'function' && n(6),
          o2 !== void 0 && typeof o2 != 'function' && n(7),
          r(t3))
        ) {
          var c2 = w(e2),
            s2 = R(e2, t3, void 0),
          ...
          return typeof Promise != 'undefined' && f2 instanceof Promise
            ? f2.then(
                function (n2) {
      ...
      typeof (t2 == null ? void 0 : t2.useProxies) == 'boolean' &&
        this.setUseProxies(t2.useProxies),
      typeof (t2 == null ? void 0 : t2.autoFreeze) == 'boolean' &&
        this.setAutoFreeze(t2.autoFreeze);
  }
  var i2 = e.prototype;
  return (
...
var Fragment = class {
  ...
  resolve() {
    return fn(this, draft => {
      draft.fragments = draft.fragments.map((f2, idx) =>
        f2._resolveRename(String(idx))
      );
    });
  }
  _resolveRename(id) {
  ...
  toVariables() {
    return this.fragments.reduce(
      (acc, f2) => ({ ...acc, ...f2.toVariables() }),
      this.variables.reduce(
        (acc, v2) => ({ ...acc, [v2.name]: this._toVariableValue(v2.value) }),
        {}
      )
    );
  }
  toParameters() {
    return this.fragments.reduce(
      (acc, f2) => [...acc, ...f2.toParameters()],
      this.variables.reduce((acc, v2) => [...acc, [v2.name, v2.type]], [])
    );
  }
  fieldNodes() {
      ...
      definitions: [
        {
          ...
          operation,
          name: nameKind(name),
          variableDefinitions: this.toParameters().map(([name2, type]) =>
            variableDefinition(name2, type)
          ),
...
var printDocASTReducer = {
  ...
  OperationDefinition: function OperationDefinition(node) {
    ...
    return !name && !directives && !varDefs && op === 'query'
      ? selectionSet
      : join2([op, join2([name, varDefs]), directives, selectionSet], ' ');
  },
  ...
  FragmentDefinition: function FragmentDefinition(_ref7) {
    ...
    return (
      'fragment '
        .concat(name)
        .concat(wrap2('(', join2(variableDefinitions, ', '), ')'), ' ') +
      'on '
        .concat(typeCondition, ' ')
        .concat(wrap2('', join2(directives, ' '), ' ')) +
      selectionSet
    );
  },
  ...
  SchemaDefinition: addDescription(function (_ref20) {
    ...
    return join2(
      ['schema', join2(directives, ' '), block(operationTypes)],
      ' '
    );
  }),
  ...
  InputValueDefinition: addDescription(function (_ref25) {
    ...
    return join2(
      [name + ': ' + type, wrap2('= ', defaultValue), join2(directives, ' ')],
      ' '
    );
  }),
  ...
  EnumTypeExtension: function EnumTypeExtension(_ref37) {
    var name = _ref37.name,
      ...
      values2 = _ref37.values;
    return join2(
      ['extend enum', name, join2(directives, ' '), block(values2)],
      ' '
    );
  },
  InputObjectTypeExtension: function InputObjectTypeExtension(_ref38) {
    ...
    return join2(
      ['extend input', name, join2(directives, ' '), block(fields)],
      ' '
    );
  },
};
...
var _Query = class {
  constructor(model) {
    ...
    this.model = model;
    this.paramTypes = {
      filters: (_a7 = this.model) == null ? void 0 : _a7.filterType,
    };
    this.attrs = new Set();
    this.arguments = {};
    this.filters = {};
      ...
      subqueries = fn(subqueries, draft => {
        if (Array.isArray(value)) {
          ...
          draft[name] = fn(draft[name], draft2 => {
            var _a7;
            draft2.paramTypes =
              (_a7 = this.model.fields[name]) == null ? void 0 : _a7.args;
            draft2.single = true;
          });
        }
      });
  ...
  buildFragmentArguments(fragment) {
    ...
    fragment = Object.entries(this.arguments || {}).reduce(
      (fragment2, [name, value]) =>
        fragment2.argument(name, value, this.paramTypes[name]),
      fragment
    );
    return fragment;
  }
  buildFragmentSubqueries(fragment) {
    ...
    if (unionFragments.length > 0) {
      ...
      const attrFragments = Array.from(this.attrs)
        .filter(attr2 => typeof attr2 !== 'string')
        .flatMap(attr2 =>
          Object.entries(attr2).map(([name, args]) =>
      ...
      return fragment
        ...
        .attr(
          ...Array.from(this.attrs).filter(attr2 => typeof attr2 === 'string')
        );
    }
  }
  buildQueryFragment(name = this.queryName, union2 = false) {
    ...
    let fragment = new Fragment(
      name,
      (_a7 = this.model) == null ? void 0 : _a7.typename
    );
    if (union2) {
  ...
  get queryFragment() {
    return memoize2(this, 'queryFragment', () =>
...
var _ApplicationModel = class {
  ...
  static async query(fragment) {
    ...
    return _ApplicationModel.client.query(
  ...
  static async mutate(fragment) {
    const mutationFragment = fragment
      .fragment(_ApplicationModel.buildErrorFragment())
      .resolve();
    return _ApplicationModel.client.mutate(
  ...
  async mutate(fragment, options = {}) {
    ...
    const data = await _ApplicationModel.mutate(
    ...
    if (typeof this[methodName] === 'function') {
      ...
      if (field && field.writeShape) {
        return field.writeShape.reduce((acc, shapeKey) => {
          if (value[shapeKey] === void 0) return acc;
...
function shouldInclude(_a7, variables) {
  ...
  return getInclusionDirectives(directives).every(function (_a8) {
    var directive = _a8.directive,
      ifArgument = _a8.ifArgument;
    ...
    if (ifArgument.value.kind === 'Variable') {
      ...
      __DEV__
        ...
        : invariant2(evaledValue !== void 0, 43);
    } else {
...
function hasClientExports(document2) {
  return (
    document2 &&
    hasDirectives(['client'], document2) &&
    hasDirectives(['export'], document2)
  );
}
  ...
  if (directives && directives.length) {
    directives.forEach(function (directive) {
      ...
      __DEV__
        ...
        : invariant2(directiveArguments && directiveArguments.length === 1, 44);
      ...
      __DEV__
        ...
        : invariant2(ifArgument.name && ifArgument.name.value === 'if', 45);
...
function getFragmentQueryDocument(document2, fragmentName) {
  ...
  if (typeof actualFragmentName === 'undefined') {
    __DEV__
      ...
      : invariant2(fragments.length === 1, 48);
...
function checkDocument(doc) {
  __DEV__
    ...
    : invariant2(doc && doc.kind === 'Document', 50);
  ...
  __DEV__
    ...
    : invariant2(operations.length <= 1, 52);
  return doc;
}
...
function getQueryDefinition(doc) {
  ...
  __DEV__
    ...
    : invariant2(queryDef && queryDef.operation === 'query', 53);
  return queryDef;
}
function getFragmentDefinition(doc) {
  __DEV__
    ...
    : invariant2(doc.kind === 'Document', 54);
  __DEV__
    ? invariant2(
        doc.definitions.length <= 1,
        'Fragment must have exactly one definition.'
      )
    : invariant2(doc.definitions.length <= 1, 55);
  ...
  __DEV__
    ...
    : invariant2(fragmentDef.kind === 'FragmentDefinition', 56);
  return fragmentDef;
}
...
function isEmpty2(op, fragments) {
  return op.selectionSet.selections.every(function (selection) {
    return (
      ...
      isEmpty2(fragments[selection.name.value], fragments)
    );
  });
}
...
function removeDirectivesFromDocument(directives, doc) {
  ...
  if (
    modifiedDoc &&
    filterInPlace(variablesToRemove, function (v2) {
      ...
      SelectionSet: {
        enter: function (node, _key, parent2) {
          ...
          if (
            isField(field) &&
            field.directives &&
            field.directives.some(function (d2) {
          ...
          return __assign(__assign({}, node), {
            selections: __spreadArray(__spreadArray([], selections), [
              TYPENAME_FIELD,
            ]),
          });
        },
      ...
      Object.keys(source).forEach(function (sourceKey) {
        if (hasOwnProperty27.call(target, sourceKey)) {
          ...
          if (source[sourceKey] !== targetValue) {
            var result3 = _this.reconciler.apply(
              _this,
              __spreadArray([target, source, sourceKey], context)
            );
...
function _createForOfIteratorHelperLoose(o2, allowArrayLike) {
  var it =
    (typeof Symbol !== 'undefined' && o2[Symbol.iterator]) || o2['@@iterator'];
      ...
      if (method2) {
        return new C2(function (observer) {
          enqueue(function () {
            ...
            for (
              var _iterator = _createForOfIteratorHelperLoose(method2.call(x2)),
                _step;
...
__DEV__
  ? invariant2(typeof DEV_default === 'boolean', DEV_default)
  : invariant2(typeof DEV_default === 'boolean', 59);
...
function validateOperation(operation) {
  ...
  for (var _i = 0, _a7 = Object.keys(operation); _i < _a7.length; _i++) {
    ...
    if (OPERATION_FIELDS.indexOf(key) < 0) {
      throw __DEV__
        ? new InvariantError('illegal argument: ' + key)
        : new InvariantError(29);
    }
  }
  return operation;
}
  ...
  if (!transformedOperation.operationName) {
    transformedOperation.operationName =
      typeof transformedOperation.query !== 'string'
        ? getOperationName(transformedOperation.query) || void 0
        : '';
  }
...
var ApolloLink = (function () {
  ...
  ApolloLink2.prototype.split = function (test, left, right) {
    return this.concat(
      ApolloLink2.split(test, left, right || new ApolloLink2(passthrough))
    );
  };
...
__DEV__
  ? invariant2(typeof DEV_default === 'boolean', DEV_default)
  : invariant2(typeof DEV_default === 'boolean', 24);
    ...
    return response
      ...
      .then(function (result3) {
        ...
        if (
          ...
          !hasOwnProperty28.call(result3, 'data') &&
          !hasOwnProperty28.call(result3, 'errors')
        ) {
          throwServerError(
            response,
            result3,
...
var createHttpLink = function (linkOptions) {
  ...
  var _a7 = linkOptions.uri,
    uri = _a7 === void 0 ? '/graphql' : _a7,
  ...
  return new ApolloLink(function (operation) {
    ...
    if (context.clientAwareness) {
      var _a8 = context.clientAwareness,
        name_1 = _a8.name,
        version2 = _a8.version;
      if (name_1) {
    ...
    var contextHeaders = __assign(
      __assign({}, clientAwarenessHeaders),
      context.headers
    );
    var contextConfig = {
      http: context.http,
    ...
    var _b2 = selectHttpOptionsAndBody(
        operation,
        fallbackHttpConfig,
        linkConfig,
        contextConfig
...
function dep(options) {
  ...
  depend.dirty = function dirty(key, entryMethodName) {
    ...
    if (dep2) {
      var m_1 =
        entryMethodName && hasOwnProperty30.call(EntryMethods, entryMethodName)
          ? entryMethodName
          : 'setDirty';
...
var ApolloCache = (function () {
  ...
  ApolloCache2.prototype.recordOptimisticTransaction = function (
    transaction,
    optimisticId
  ) {
  ...
  ApolloCache2.prototype.writeFragment = function (_a7) {
    var id = _a7.id,
      data = _a7.data,
      fragment = _a7.fragment,
      fragmentName = _a7.fragmentName,
      options = __rest(_a7, ['id', 'data', 'fragment', 'fragmentName']);
    return this.write(
      Object.assign(options, {
...
function getTypenameFromStoreObject(store2, objectOrReference) {
  return isReference(objectOrReference)
    ? store2.get(objectOrReference.__ref, '__typename')
...
function selectionSetMatchesResult(selectionSet, result3, variables) {
  if (isNonNullObject(result3)) {
    return Array.isArray(result3)
      ? result3.every(function (item) {
  ...
  EntityStore2.prototype.delete = function (dataId, fieldName, args) {
    ...
    if (storeObject) {
      ...
      return this.modify(
        dataId,
        storeFieldName
          ? ((_a7 = {}), (_a7[storeFieldName] = delModifier), _a7)
          : delModifier
      );
    }
    return false;
...
(function (EntityStore2) {
  var Root = (function (_super) {
    ...
    function Root2(_a7) {
      var policies = _a7.policies,
        _b = _a7.resultCaching,
...
var Layer = (function (_super) {
  ...
  Layer2.prototype.removeLayer = function (layerId) {
    ...
    if (parent2 === this.parent) return this;
  ...
  function Stump2(root3) {
    return (
      _super.call(
        ...
        root3,
        function () {},
        new CacheGroup(root3.group.caching, root3.group)
      ) || this
    );
  }
...
var StoreReader = (function () {
  function StoreReader2(config) {
    ...
    this.executeSelectionSet = wrap3(
      function (options) {
        var _a7;
        ...
        makeCacheKey: function (
          ...
          if (supportsResultCaching(context.store)) {
            return context.store.makeCacheKey(
              selectionSet,
              isReference(parent2) ? parent2.__ref : parent2,
              context.varString,
              canonizeResults
            );
          }
    ...
    this.executeSubSelectedArray = wrap3(
      function (options) {
        maybeDependOnExistenceOfEntity(
          options.context.store,
          options.enclosingRef.__ref
  ...
  StoreReader2.prototype.diffQueryAgainstStore = function (_a7) {
    var store2 = _a7.store,
      query = _a7.query,
      _b = _a7.rootId,
      rootId = _b === void 0 ? 'ROOT_QUERY' : _b,
      variables = _a7.variables,
      _c = _a7.returnPartialData,
      returnPartialData = _c === void 0 ? true : _c,
      _d = _a7.canonizeResults,
      canonizeResults = _d === void 0 ? true : _d;
    var policies = this.config.cache.policies;
    variables = __assign(
      __assign({}, getDefaultValues(getQueryDefinition(query))),
      variables
    );
  ...
  StoreReader2.prototype.isFresh = function (
    result3,
    parent2,
    selectionSet,
    context
    ...
    if (
      ...
      this.knownResults.get(result3) === selectionSet
    ) {
      var latest = this.executeSelectionSet.peek(
        selectionSet,
        parent2,
        context,
        this.canon.isKnown(result3)
      );
  ...
  StoreReader2.prototype.execSelectionSetImpl = function (_a7) {
    var _this = this;
    var selectionSet = _a7.selectionSet,
      objectOrReference = _a7.objectOrReference,
      enclosingRef = _a7.enclosingRef,
      context = _a7.context;
    if (
      isReference(objectOrReference) &&
    ...
    workSet.forEach(function (selection) {
      ...
      if (isField(selection)) {
        ...
        if (fieldValue !== void 0) {
          objectsToMerge.push(
            ((_a8 = {}), (_a8[resultName] = fieldValue), _a8)
          );
        }
        ...
        __DEV__
          ? invariant2(
              ...
              'Missing selection set for object of type ' +
                getTypenameFromStoreObject(store2, value) +
                ' returned for query field ' +
                field.name.value
            )
          : invariant2(!isReference(value), 8);
...
var StoreWriter = (function () {
  ...
  StoreWriter2.prototype.writeToStore = function (store2, _a7) {
    ...
    var query = _a7.query,
      ...
      dataId = _a7.dataId,
      variables = _a7.variables,
      overwrite = _a7.overwrite;
    var operationDefinition = getOperationDefinition(query);
    var merger = makeProcessedFieldsMerger();
    variables = __assign(
      __assign({}, getDefaultValues(operationDefinition)),
      variables
    );
    var context = {
      store: store2,
    ...
    if (!isReference(ref)) {
      throw __DEV__
        ? new InvariantError(
            'Could not identify object ' + JSON.stringify(result3)
          )
        : new InvariantError(9);
    }
    context.incomingById.forEach(function (_a8, dataId2) {
      var fields = _a8.fields,
        mergeTree = _a8.mergeTree,
        selections = _a8.selections;
      ...
      if (__DEV__ && !context.overwrite) {
        var hasSelectionSet_1 = function (storeFieldName) {
          return fieldsWithSelectionSets_1.has(
  ...
  StoreWriter2.prototype.processSelectionSet = function (_a7) {
    var _this = this;
    var dataId = _a7.dataId,
      result3 = _a7.result,
      selectionSet = _a7.selectionSet,
      context = _a7.context,
      mergeTree = _a7.mergeTree;
    var policies = this.cache.policies;
    var _b = policies.identify(result3, selectionSet, context.fragmentMap),
      id = _b[0],
      keyObject = _b[1];
    dataId = dataId || id;
    if (typeof dataId === 'string') {
      ...
      if (
        this.reader &&
        this.reader.isFresh(result3, ref, selectionSet, context)
      ) {
        return ref;
      }
    }
    ...
    var typename =
      ...
      getTypenameFromResult(result3, selectionSet, context.fragmentMap) ||
      ...
      if (isField(selection)) {
        ...
        context.clientOnly =
          ...
          !!(
            ...
            selection.directives.some(function (d2) {
        ...
        if (value !== void 0) {
          ...
          var merge2 = policies.getMergeFunction(
            typename,
            selection.name.value,
            childTypename
          );
          ...
          incomingFields = context.merge(
            incomingFields,
            ((_a8 = {}), (_a8[storeFieldName] = incomingValue), _a8)
          );
        } else if (
          !context.clientOnly &&
  ...
  StoreWriter2.prototype.processFieldValue = function (
    value,
    field,
    context,
    mergeTree
    ...
    if (Array.isArray(value)) {
      return value.map(function (item, i2) {
        var value2 = _this.processFieldValue(
          item,
          field,
          context,
          getChildMergeTree(mergeTree, i2)
        );
  ...
  StoreWriter2.prototype.applyMerges = function (
    mergeTree,
    existing,
    incoming,
    context,
    ...
    if (mergeTree.map.size && !isReference(incoming)) {
      ...
      var getValue_1 = function (from2, name) {
        return Array.isArray(from2)
          ? typeof name === 'number'
            ? from2[name]
            : void 0
          : context.store.getFieldValue(from2, String(name));
      };
    ...
    if (mergeTree.info) {
      return this.cache.policies.runMergeFunction(
        ...
        context,
        getStorageArgs &&
          (_a7 = context.store).getStorage.apply(_a7, getStorageArgs)
      );
    }
    return incoming;
  };
...
function mergeMergeTrees(left, right) {
  ...
  var info =
    left.info && right.info
      ? __assign(__assign({}, left.info), right.info)
      : left.info || right.info;
...
function warnAboutDataLoss(existingRef, incomingObj, storeFieldName, store2) {
  ...
  var parentType =
    store2.getFieldValue(existingRef, '__typename') ||
    store2.getFieldValue(incomingObj, '__typename');
  var fieldName = fieldNameFromStoreName(storeFieldName);
  ...
  __DEV__ &&
    invariant2.warn(
      'Cache data may be lost when replacing the ' +
        ...
        JSON.stringify(existing).slice(0, 1e3) +
        '\n  incoming: ' +
        JSON.stringify(incoming).slice(0, 1e3) +
...
var defaultDataIdFromObject = function (_a7, context) {
  var __typename = _a7.__typename,
    id = _a7.id,
    _id = _a7._id;
  if (typeof __typename === 'string') {
    if (context) {
      context.keyObject =
        id !== void 0 ? { id } : _id !== void 0 ? { _id } : void 0;
    }
    if (id === void 0) id = _id;
    if (id !== void 0) {
      return (
...
var Policies = (function () {
  ...
  Policies2.prototype.addTypePolicies = function (typePolicies) {
    ...
    Object.keys(typePolicies).forEach(function (typename) {
      var _a7 = typePolicies[typename],
        queryType = _a7.queryType,
        mutationType = _a7.mutationType,
        subscriptionType = _a7.subscriptionType,
        incoming = __rest(_a7, [
          'queryType',
          'mutationType',
          'subscriptionType',
    ...
    if (fields) {
      Object.keys(fields).forEach(function (fieldName) {
        ...
        if (typeof incoming2 === 'function') {
          ...
          var keyArgs = incoming2.keyArgs,
            read = incoming2.read,
            merge2 = incoming2.merge;
          existing2.keyFn =
            keyArgs === false
              ? simpleKeyArgsFn
  ...
  Policies2.prototype.setRootTypename = function (which, typename) {
    ...
    if (typename !== old) {
      __DEV__
        ? invariant2(
            !old || old === which,
            'Cannot change root ' + which + ' __typename more than once'
          )
        : invariant2(!old || old === which, 3);
    ...
    if (!hasOwn.call(this.typePolicies, typename)) {
      ...
      if (supertypes && supertypes.size) {
        supertypes.forEach(function (supertype) {
          var _a7 = _this.getTypePolicy(supertype),
            fields = _a7.fields,
            rest2 = __rest(_a7, ['fields']);
  ...
  Policies2.prototype.getFieldPolicy = function (
    typename,
    fieldName,
    createIfMissing
  ) {
  ...
  Policies2.prototype.fragmentMatches = function (
    fragment,
    typename,
    result3,
    variables
    ...
    if (this.usingPossibleTypes && this.supertypeMap.has(supertype)) {
      ...
      var maybeEnqueue_1 = function (subtype) {
        ...
        if (
          supertypeSet2 &&
          supertypeSet2.size &&
          workQueue_1.indexOf(supertypeSet2) < 0
        ) {
      ...
      for (var i2 = 0; i2 < workQueue_1.length; ++i2) {
        ...
        if (supertypeSet.has(supertype)) {
          if (!typenameSupertypeSet.has(supertype)) {
            if (checkingFuzzySubtypes) {
              __DEV__ &&
                invariant2.warn(
                  'Inferring subtype ' + typename + ' of supertype ' + supertype
                );
            }
        ...
        if (
          ...
          i2 === workQueue_1.length - 1 &&
          selectionSetMatchesResult(fragment.selectionSet, result3, variables)
        ) {
  ...
  Policies2.prototype.getMergeFunction = function (
    parentTypename,
    fieldName,
    childTypename
  ) {
  ...
  Policies2.prototype.runMergeFunction = function (
    existing,
    incoming,
    _a7,
    context,
...
function makeFieldFunctionOptions(
  ...
  var _a7 = context.store,
    toReference = _a7.toReference,
    canRead = _a7.canRead;
  return {
  ...
  specifier.forEach(function (s2) {
    if (Array.isArray(s2)) {
      if (
        ...
        keyObj[lastActualKey] = computeKeyObject(
      ...
      if (hasOwn.call(response, responseName)) {
        keyObj[(lastActualKey = s2)] =
          response[(lastResponseKey = responseName)];
      } else {
        __DEV__
          ? invariant2(
              !strict,
...
var InMemoryCache = (function (_super) {
  ...
  InMemoryCache2.prototype.resetResultCache = function (resetResultIdentities) {
    ...
    this.maybeBroadcastWatch = wrap3(
      function (c2, options) {
      ...
      },
      {
        ...
        makeCacheKey: function (c2) {
          ...
          if (supportsResultCaching(store2)) {
            var optimistic = c2.optimistic,
              rootId = c2.rootId,
              variables = c2.variables;
            return store2.makeCacheKey(
              c2.query,
              c2.callback,
  ...
  InMemoryCache2.prototype.read = function (options) {
    var _a7 = options.returnPartialData,
      returnPartialData = _a7 === void 0 ? false : _a7;
    try {
      return (
  ...
  InMemoryCache2.prototype.batch = function (options) {
    var _this = this;
    var update2 = options.update,
      _a7 = options.optimistic,
      optimistic = _a7 === void 0 ? true : _a7,
      removeOptimistic = options.removeOptimistic,
      onWatchUpdated = options.onWatchUpdated;
    var perform = function (layer) {
      var _a8 = _this,
        data = _a8.data,
        optimisticData = _a8.optimisticData;
      ++_this.txCount;
      if (layer) {
  ...
  InMemoryCache2.prototype.performTransaction = function (
    update2,
    optimisticId
  ) {
    return this.batch({
  ...
  InMemoryCache2.prototype.broadcastWatch = function (c2, options) {
    ...
    if (options) {
      ...
      if (
        ...
        options.onWatchUpdated.call(this, c2, diff, lastDiff) === false
      ) {
        return;
      }
    }
...
__DEV__
  ? invariant2(typeof DEV_default === 'boolean', DEV_default)
  : invariant2(typeof DEV_default === 'boolean', 1);

// node_modules/@apollo/client/errors/index.js
__DEV__
  ? invariant2(typeof DEV_default === 'boolean', DEV_default)
  : invariant2(typeof DEV_default === 'boolean', 22);
...
var ApolloError = (function (_super) {
  ...
  function ApolloError2(_a7) {
    var graphQLErrors = _a7.graphQLErrors,
      clientErrors = _a7.clientErrors,
      networkError = _a7.networkError,
      errorMessage = _a7.errorMessage,
      extraInfo = _a7.extraInfo;
...
var ObservableQuery = (function (_super) {
  ...
  function ObservableQuery2(_a7) {
    var queryManager = _a7.queryManager,
      queryInfo = _a7.queryInfo,
      options = _a7.options;
    var _this =
      _super.call(this, function (observer) {
        try {
  ...
  ObservableQuery2.prototype.getCurrentResult = function (saveAsLastResult) {
    ...
    var networkStatus =
      ...
      NetworkStatus.ready;
    var result3 = __assign(__assign({}, lastResult), {
    ...
    if (!this.queryManager.transform(this.options.query).hasForcedResolvers) {
      ...
      var _a7 = this.options.fetchPolicy,
        fetchPolicy = _a7 === void 0 ? 'cache-first' : _a7;
      if (diff.complete) {
        if (
          result3.networkStatus === NetworkStatus.loading &&
  ...
  ObservableQuery2.prototype.getLast = function (key, variablesMustMatch) {
    ...
    if (
      last2 &&
      last2[key] &&
      (!variablesMustMatch || equal(last2.variables, this.variables))
    ) {
      return last2[key];
    }
  };
  ...
  ObservableQuery2.prototype.refetch = function (variables) {
    ...
    if (variables && !equal(this.options.variables, variables)) {
      reobserveOptions.variables = this.options.variables = __assign(
        __assign({}, this.options.variables),
        variables
      );
    }
    ...
    var subscription = this.queryManager
      ...
      .subscribe({
        ...
        error: function (err) {
          ...
          __DEV__ &&
            invariant2.error('Unhandled GraphQL subscription error', err);
        },
      });
  ...
  ObservableQuery2.prototype.updatePolling = function () {
    ...
    var _a7 = this,
      pollingInfo = _a7.pollingInfo,
      pollInterval = _a7.options.pollInterval;
    if (!pollInterval) {
      if (pollingInfo) {
  ...
  ObservableQuery2.prototype.updateLastResult = function (
    newResult,
    variables
  ) {
    if (variables === void 0) {
  ...
  ObservableQuery2.prototype.reobserve = function (
    newOptions,
    newNetworkStatus
  ) {
    var _this = this;
    ...
    var options = useDisposableConcast
      ? compact2(this.options, newOptions)
      : Object.assign(this.options, compact2(newOptions));
...
var LocalState = (function () {
  function LocalState2(_a7) {
    var cache2 = _a7.cache,
      client2 = _a7.client,
      resolvers = _a7.resolvers,
      fragmentMatcher = _a7.fragmentMatcher;
    this.cache = cache2;
    if (client2) {
      this.client = client2;
    }
  ...
  LocalState2.prototype.runResolvers = function (_a7) {
    var document2 = _a7.document,
      remoteResult = _a7.remoteResult,
      context = _a7.context,
      variables = _a7.variables,
      _b = _a7.onlyRunForcedResolvers,
  ...
  LocalState2.prototype.addExportedVariables = function (
    document2,
    variables,
    context
  ) {
      ...
      return __generator(this, function (_a7) {
        if (document2) {
          return [
            ...
            this.resolveDocument(
              document2,
              this.buildRootValueFromCache(document2, variables) || {},
  ...
  LocalState2.prototype.buildRootValueFromCache = function (
    document2,
    variables
  ) {
  ...
  LocalState2.prototype.resolveDocument = function (
    document2,
    rootValue,
    context,
    variables,
  ...
  LocalState2.prototype.resolveSelectionSet = function (
    selectionSet,
    rootValue,
    execContext
  ) {
                  ...
                  this.resolveField(selection, rootValue, execContext).then(
                    function (fieldResult) {
                      ...
                      if (typeof fieldResult !== 'undefined') {
                        resultsToMerge.push(
                          ((_a9 = {}),
                          (_a9[resultKeyNameFromField(selection)] =
                            fieldResult),
                          _a9)
                        );
                      }
  ...
  LocalState2.prototype.resolveField = function (
    field,
    rootValue,
    execContext
  ) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a7) {
        ...
        return [
          2,
          resultPromise.then(function (result3) {
            if (result3 === void 0) {
  ...
  LocalState2.prototype.resolveSubSelectedArray = function (
    field,
    result3,
    execContext
  ) {
...
var QueryInfo = (function () {
  ...
  QueryInfo2.prototype.shouldWrite = function (result3, variables) {
    ...
    return !(
      ...
      equal(result3.data, lastWrite.result.data)
    );
  };
  QueryInfo2.prototype.markResult = function (
    result3,
    options,
    cacheWriteBehavior
  ) {
    ...
    if (options.fetchPolicy === 'no-cache') {
      this.updateLastDiff(
        { result: result3.data, complete: true },
...
var QueryManager = (function () {
  function QueryManager2(_a7) {
    var cache2 = _a7.cache,
      link = _a7.link,
      _b = _a7.queryDeduplication,
      queryDeduplication = _b === void 0 ? false : _b,
      onBroadcast = _a7.onBroadcast,
      _c = _a7.ssrMode,
      ssrMode = _c === void 0 ? false : _c,
      _d = _a7.clientAwareness,
      clientAwareness = _d === void 0 ? {} : _d,
      localState = _a7.localState,
      assumeImmutableResults = _a7.assumeImmutableResults;
  ...
  QueryManager2.prototype.mutate = function (_a7) {
    var mutation = _a7.mutation,
      variables = _a7.variables,
      optimisticResponse = _a7.optimisticResponse,
      updateQueries = _a7.updateQueries,
      _b = _a7.refetchQueries,
      refetchQueries = _b === void 0 ? [] : _b,
      _c = _a7.awaitRefetchQueries,
      awaitRefetchQueries = _c === void 0 ? false : _c,
      updateWithProxyFn = _a7.update,
      onQueryUpdated = _a7.onQueryUpdated,
      _d = _a7.errorPolicy,
      errorPolicy = _d === void 0 ? 'none' : _d,
      _e = _a7.fetchPolicy,
      fetchPolicy = _e === void 0 ? 'network-only' : _e,
      keepRootFields = _a7.keepRootFields,
      context = _a7.context;
    return __awaiter(this, void 0, void 0, function () {
          ...
          case 2:
            ...
            return [
              ...
              new Promise(function (resolve, reject2) {
                return asyncMap(
                  self2.getObservableFromLink(
                    mutation,
                    __assign(__assign({}, context), { optimisticResponse }),
                    variables,
                    false
                  ),
                  function (result3) {
                    if (
                      graphQLResultHasError(result3) &&
                      errorPolicy === 'none'
                    ) {
    ...
    if (!skipCache && shouldWriteResult(result3, mutation.errorPolicy)) {
      ...
      if (updateQueries_1) {
        this.queries.forEach(function (_a7, queryId) {
          ...
          if (
            !queryName ||
            !hasOwnProperty31.call(updateQueries_1, queryName)
          ) {
            return;
          }
          var updater = updateQueries_1[queryName];
          var _b = _this.queries.get(queryId),
            document2 = _b.document,
        ...
        updateCache: function (cache3) {
          ...
          if (update2) {
            if (!skipCache) {
              ...
              if (diff.complete) {
                result3 = __assign(__assign({}, result3), {
                  data: diff.result,
                });
              }
            }
  ...
  QueryManager2.prototype.markMutationOptimistic = function (
    optimisticResponse,
    mutation
  ) {
    var _this = this;
    ...
    return this.cache.recordOptimisticTransaction(function (cache2) {
      try {
        _this.markMutationResult(
          __assign(__assign({}, mutation), { result: { data } }),
          cache2
        );
      } catch (error) {
  ...
  QueryManager2.prototype.fetchQuery = function (
    queryId,
    options,
    networkStatus
  ) {
  ...
  QueryManager2.prototype.getVariables = function (document2, variables) {
    return __assign(
      __assign({}, this.transform(document2).defaultVars),
      variables
    );
  };
  ...
  QueryManager2.prototype.query = function (options, queryId) {
    ...
    __DEV__
      ...
      : invariant2(options.query, 17);
    __DEV__
      ? invariant2(
          options.query.kind === 'Document',
          'You must wrap the query string in a "gql" tag.'
        )
      : invariant2(options.query.kind === 'Document', 18);
    __DEV__
      ? invariant2(
          !options.returnPartialData,
          'returnPartialData option only supported on watchQuery.'
        )
      : invariant2(!options.returnPartialData, 19);
    __DEV__
      ? invariant2(
          !options.pollInterval,
          'pollInterval option only supported on watchQuery.'
        )
      : invariant2(!options.pollInterval, 20);
  ...
  QueryManager2.prototype.getObservableQueries = function (include) {
    ...
    this.queries.forEach(function (_a7, queryId) {
      var oq = _a7.observableQuery,
        document2 = _a7.document;
      if (oq) {
        if (include === 'all') {
        ...
        if (
          ...
          (document2 && queryNamesAndDocs.has(document2))
        ) {
          queries.set(queryId, oq);
  ...
  QueryManager2.prototype.startGraphQLSubscription = function (_a7) {
    var _this = this;
    var query = _a7.query,
      fetchPolicy = _a7.fetchPolicy,
      errorPolicy = _a7.errorPolicy,
      variables = _a7.variables,
      _b = _a7.context,
    ...
    var makeObservable = function (variables2) {
      return _this
        .getObservableFromLink(query, context, variables2)
  ...
  QueryManager2.prototype.getObservableFromLink = function (
    query,
    context,
    variables,
    deduplication
      ...
      deduplication =
        (_a7 =
          context === null || context === void 0
            ? void 0
            : context.queryDeduplication) !== null && _a7 !== void 0
          ? _a7
    ...
    if (serverQuery) {
      ...
      var operation = {
        ...
        context: this.prepareContext(
          __assign(__assign({}, context), { forceFetch: !deduplication })
        ),
      };
  ...
  QueryManager2.prototype.getResultsFromLink = function (
    queryInfo,
    cacheWriteBehavior,
    options
  ) {
  ...
  QueryManager2.prototype.fetchQueryObservable = function (
    queryId,
    options,
    networkStatus
  ) {
  ...
  QueryManager2.prototype.refetchQueries = function (_a7) {
    var _this = this;
    var updateCache = _a7.updateCache,
      include = _a7.include,
      _b = _a7.optimistic,
      optimistic = _b === void 0 ? false : _b,
      _c = _a7.removeOptimistic,
      removeOptimistic =
        _c === void 0
          ? optimistic
  ...
  QueryManager2.prototype.fetchQueryByPolicy = function (
    queryInfo,
    _a7,
    networkStatus
  ) {
    ...
    var query = _a7.query,
      variables = _a7.variables,
      fetchPolicy = _a7.fetchPolicy,
      refetchWritePolicy = _a7.refetchWritePolicy,
      errorPolicy = _a7.errorPolicy,
      returnPartialData = _a7.returnPartialData,
      context = _a7.context,
      notifyOnNetworkStatusChange = _a7.notifyOnNetworkStatusChange;
      ...
      var fromData = function (data2) {
        return Observable.of(
          __assign(
            ...
            diff2.complete ? null : { partial: true }
          )
        );
      };
...
var ApolloClient = (function () {
  function ApolloClient2(options) {
    ...
    var uri = options.uri,
      ...
      defaultOptions2 = options.defaultOptions,
  ...
  ApolloClient2.prototype.resetStore = function () {
    ...
    return Promise.resolve()
      ...
      .then(function () {
        return Promise.all(
          _this.resetStoreCallbacks.map(function (fn2) {
            return fn2();
          })
        );
      })
  ...
  ApolloClient2.prototype.clearStore = function () {
    ...
    return Promise.resolve()
      ...
      .then(function () {
        return Promise.all(
          _this.clearStoreCallbacks.map(function (fn2) {
            return fn2();
          })
        );
      });
  ...
  ApolloClient2.prototype.setLocalStateFragmentMatcher = function (
    fragmentMatcher
  ) {
...
var MockLink = (function (_super) {
  ...
  MockLink2.prototype.normalizeMockedResponse = function (mockedResponse) {
    ...
    var queryWithoutConnection = removeConnectionDirectiveFromDocument(
      newMockedResponse.request.query
    );
    __DEV__
      ? invariant2(queryWithoutConnection, 'query is required')
      : invariant2(queryWithoutConnection, 60);
